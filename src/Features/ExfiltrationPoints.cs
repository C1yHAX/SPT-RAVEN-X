...
internal class ExfiltrationPoints : PointOfInterests
{
	...
	internal static ExfiltrationPoint[]? GetExfiltrationPoints(EPlayerSide side, GameWorld world)
	{
	...
	internal static ExfiltrationPoint[]? GetEligibleExfiltrationPoints(EPlayerSide side, GameWorld world, Profile profile)
	{
		var ect = world.ExfiltrationController;
